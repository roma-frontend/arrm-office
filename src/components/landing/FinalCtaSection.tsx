            ...
            >
              {!isSubmitted ? (
                <form onSubmit={handleSubmit} className="flex flex-col gap-3">
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3.5 rounded-xl border focus:outline-none focus:ring-2 focus:ring-blue-500/50 transition-all"
                    style={{
              ...
              >
                ...
                <a
                  ...
                  className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium transition-all hover:scale-[1.04] bg-[#2AABEE]/10 text-[#2AABEE] hover:bg-[#2AABEE]/20"
                >
